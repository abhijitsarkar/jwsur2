...
public class AdagesTest extends JerseyTest {
	...
	Adage adage = target("adages").request()
		.accept(MediaType.APPLICATION_XML).get(Adage.class);
	...
	Adage adage = target("adages/json").request()
	...
	String adage = target("adages/plain").request()
