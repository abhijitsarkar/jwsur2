...
public interface PredictionsSOAP {
    ...
    @Action(input = "http://predictions.ch5.jwsur2.mkalin.github.com/PredictionsSOAP/createRequest", output = "http://predictions.ch5.jwsur2.mkalin.github.com/PredictionsSOAP/createResponse", fault = { @FaultAction(className = VerbosityException_Exception.class, value = "http://predictions.ch5.jwsur2.mkalin.github.com/PredictionsSOAP/create/Fault/VerbosityException") })
     ...
     * 
     * @return returns
     *         java.util.List<com.github.mkalin.jwsur2.ch5.predictions.client
    ...
    @Action(input = "http://predictions.ch5.jwsur2.mkalin.github.com/PredictionsSOAP/editRequest", output = "http://predictions.ch5.jwsur2.mkalin.github.com/PredictionsSOAP/editResponse", fault = { @FaultAction(className = VerbosityException_Exception.class, value = "http://predictions.ch5.jwsur2.mkalin.github.com/PredictionsSOAP/edit/Fault/VerbosityException") })
    public String edit(@WebParam(name = "arg0", targetNamespace = "") int arg0,
	    @WebParam(name = "arg1", targetNamespace = "") String arg1,
