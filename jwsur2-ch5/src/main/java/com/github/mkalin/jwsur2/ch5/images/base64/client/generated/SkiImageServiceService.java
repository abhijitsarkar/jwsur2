 ...
 * 
 */
@WebServiceClient(name = "SkiImageServiceService", targetNamespace = "http://base64.images.ch5.jwsur2.mkalin.github.com/", wsdlLocation = "http://localhost:8080/jwsur2-ch5/images/base64?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SKIIMAGESERVICESERVICE_QNAME = new QName("http://base64.images.ch5.jwsur2.mkalin.github.com/", "SkiImageServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jwsur2-ch5/images/base64?wsdl");
    ...
    public SkiImageService getSkiImageServicePort() {
        return super.getPort(new QName("http://base64.images.ch5.jwsur2.mkalin.github.com/", "SkiImageServicePort"), SkiImageService.class);
    }
    ...
    public SkiImageService getSkiImageServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://base64.images.ch5.jwsur2.mkalin.github.com/", "SkiImageServicePort"), SkiImageService.class, features);
    }
