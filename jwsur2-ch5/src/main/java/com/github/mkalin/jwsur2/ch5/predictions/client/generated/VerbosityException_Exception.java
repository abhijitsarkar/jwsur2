...
public class VerbosityException_Exception extends Exception {
     ...
     * @param message
     */
    public VerbosityException_Exception(String message,
	    VerbosityException faultInfo) {
	super(message);
     ...
     */
    public VerbosityException_Exception(String message,
	    VerbosityException faultInfo, Throwable cause) {
	super(message, cause);
	this.faultInfo = faultInfo;
    }
     ...
     *         com.github.mkalin.jwsur2.ch5.predictions.client
     *         .generated.VerbosityException
     */
