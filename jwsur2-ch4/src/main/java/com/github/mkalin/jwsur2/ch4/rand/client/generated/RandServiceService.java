 ...
 * 
 */
@WebServiceClient(name = "RandServiceService", targetNamespace = "http://rand.ch4.jwsur2.mkalin.github.com/", wsdlLocation = "http://localhost:8080/jwsur2-ch4/rand?wsdl")
...
public class RandServiceService extends Service {
    ...
    private final static QName RANDSERVICESERVICE_QNAME = new QName(
	    "http://rand.ch4.jwsur2.mkalin.github.com/", "RandServiceService");

    static {
	URL url = null;
	WebServiceException e = null;
	try {
	    url = new URL("http://localhost:8080/jwsur2-ch4/rand?wsdl");
	...
	return super.getPort(
		new QName("http://rand.ch4.jwsur2.mkalin.github.com/",
			"RandServicePort"), RandService.class);
    }
	...
	return super.getPort(
		new QName("http://rand.ch4.jwsur2.mkalin.github.com/",
			"RandServicePort"), RandService.class, features);
    }
